...
class Configure extends Command {
	...
	private function configureSms(InputInterface $input, OutputInterface $output) {
		...
		$providerQuestion = new Question('Please choose a SMS provider (customsms, sipgate, websms, playsms, clockworksms, puzzelsms, ecallsms, voipms, voipbuster, huawei_e3531, spryng, sms77io, ovh, clickatellcentral, clickatellportal, clicksend, serwersms, smsglobal): ', 'websms');
